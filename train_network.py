# USAGE
# python train_network.py --dataset images --model gs.model
...
# We initialize the number of epochs to train for, initia learning rate,and batch size
EPOCHS = 25
INIT_LR = 1e-3
BS = 32
...
for imagePath in imagePaths:
	...
	# We extract the class label from the image path and update the labels list
...
# We partition the data into training and testing splits using 75% of the data for training and the remaining 25% for testing
...
plt.title("Training Loss and Accuracy on Lord Ganpati/Lord Shiva")
plt.xlabel("Epoch #")
